...
- `SLACK_SIGNING_SECRET` — Slack webhook verification secret returned by Slack app registration
...
- Secrets optional: SLACK_APP_ID, SLACK_CONFIGURATION_ACCESS_TOKEN, SLACK_CONFIGURATION_REFRESH_TOKEN
- Registration secrets: SLACK_SIGNING_SECRET is captured from Slack app registration and stored as a secret
