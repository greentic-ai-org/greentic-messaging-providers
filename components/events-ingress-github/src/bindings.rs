            ...
            pub fn read(
                ...
                unsafe {
                    ...
                    struct RetArea(
                        [::core::mem::MaybeUninit<
                            u8,
                        >; 32 + 52 * ::core::mem::size_of::<*const u8>()],
                    );
                    let mut ret_area = RetArea(
            ...
            pub fn write(
                ...
                unsafe {
                    ...
                    struct RetArea(
                        [::core::mem::MaybeUninit<
                            u8,
                        >; 32 + 54 * ::core::mem::size_of::<*const u8>()],
                    );
                    let mut ret_area = RetArea(
                        [::core::mem::MaybeUninit::uninit(); 32
                            + 54 * ::core::mem::size_of::<*const u8>()],
                    );
                    let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
                    let vec1 = key;
                    let ptr1 = vec1.as_ptr().cast::<u8>();
                    ...
                    *ptr0
                            ...
                            match provider_id3 {
                                Some(e) => {
                                    *ptr0
                                    ...
                                    let len21 = vec21.len();
                                    *ptr0
                                        .add(8 + 44 * ::core::mem::size_of::<*const u8>())
                                        .cast::<usize>() = len21;
                                    *ptr0
                                        .add(8 + 43 * ::core::mem::size_of::<*const u8>())
                                        .cast::<*mut u8>() = ptr21.cast_mut();
                                }
                                None => {
                                    *ptr0
                    ...
                    let result36 = match l28 {
                        0 => {
                            let e = {
                                let l29 = i32::from(
                                    *ptr26.add(::core::mem::size_of::<*const u8>()).cast::<u8>(),
                                );
                                OpAck::_lift(l29 as u8)
                            };
                            Ok(e)
                        }
                        1 => {
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_events_ingress_github_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_events_ingress_github_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.41.0:greentic:events-ingress-github@0.0.1:events-ingress-github:encoded world")]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 2536] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xdc\x12\x01A\x02\x01\
...
ntic:events-ingress-github/events-ingress-github@0.0.1\x04\0\x0b\x1b\x01\0\x15ev\
ents-ingress-github\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-compo\
