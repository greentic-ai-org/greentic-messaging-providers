...
pub trait Guest {
    ...
    fn format_message(session_id: _rt::String, text: _rt::String) -> _rt::String;
}
#[doc(hidden)]
macro_rules! __export_world_webchat_cabi {
...
#[doc(hidden)]
pub(crate) use __export_world_webchat_cabi;
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_webchat_impl {
    ($ty:ident) => {
        self::export!($ty with_types_in self);
    };
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*:: __export_world_webchat_cabi!($ty with_types_in
        $($path_to_types_root)*);
    };
}
#[doc(inline)]
pub(crate) use __export_webchat_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:provider:webchat@0.0.1:webchat:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 2306] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x84\x11\x01A\x02\x01\
...
\x05\x07\x01j\x01s\x01s\x01@\x02\x0asession-ids\x04texts\0\x08\x04\0\x0csend-mes\
sage\x01\x09\x01@\x02\x0cheaders-jsons\x09body-jsons\0\x08\x04\0\x0ehandle-webho\
ok\x01\x0a\x01@\0\0\x08\x04\0\x07refresh\x01\x0b\x01@\x02\x0asession-ids\x04text\
s\0s\x04\0\x0eformat-message\x01\x0c\x04\0\x1eprovider:webchat/webchat@0.0.1\x04\
\0\x0b\x0d\x01\0\x07webchat\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dw\
