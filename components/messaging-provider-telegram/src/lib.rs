//! Telegram messaging provider component.
//!
...
pub(crate) const PROVIDER_ID: &str = "messaging-provider-telegram";
pub(crate) const PROVIDER_TYPE: &str = "messaging.telegram.bot";
pub(crate) const WORLD_ID: &str = "component-v0-v6-v0";
pub(crate) const DEFAULT_API_BASE: &str = "https://api.telegram.org";
pub(crate) const TOKEN_SECRET: &str = "TELEGRAM_BOT_TOKEN";
    ...
    for Component
{
    fn identify_instance(input_json: Vec<u8>) -> Option<String> {
        ops::extract_secret_token(&input_json)
    }
}
