//! Webex messaging provider component.
//!
...
pub(crate) const PROVIDER_ID: &str = "messaging-provider-webex";
pub(crate) const PROVIDER_TYPE: &str = "messaging.webex.bot";
...
// ============================================================================
// Configuration types (shared with config.rs)
// ============================================================================
...
mod tests {
    ...
    fn load_config_prefers_nested_config() {
        ...
        assert_eq!(cfg.default_room_id.as_deref(), Some("abc"));
    }
