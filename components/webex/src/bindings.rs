...
pub trait Guest {
    ...
    fn format_message(room_id: _rt::String, text: _rt::String) -> _rt::String;
}
#[doc(hidden)]
macro_rules! __export_world_webex_cabi {
...
#[doc(hidden)]
pub(crate) use __export_world_webex_cabi;
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_webex_impl {
    ($ty:ident) => {
        self::export!($ty with_types_in self);
    };
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*:: __export_world_webex_cabi!($ty with_types_in
        $($path_to_types_root)*);
    };
}
#[doc(inline)]
pub(crate) use __export_webex_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:provider:webex@0.0.1:webex:encoded world"
)]
#[doc(hidden)]
...
\x05\x07\x01j\x01s\x01s\x01@\x02\x07room-ids\x04texts\0\x08\x04\0\x0csend-messag\
e\x01\x09\x01@\x02\x0cheaders-jsons\x09body-jsons\0\x08\x04\0\x0ehandle-webhook\x01\
\x0a\x01@\0\0\x08\x04\0\x07refresh\x01\x0b\x01@\x02\x07room-ids\x04texts\0s\x04\0\
\x0eformat-message\x01\x0c\x04\0\x1aprovider:webex/webex@0.0.1\x04\0\x0b\x0b\x01\
\0\x05webex\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x07\
