    ...
    DescribePayload {
        ...
        secret_requirements: vec![
            DescribeSecretRequirement {
                key: "MS_GRAPH_TENANT_ID".into(),
                required: true,
                description: Some("Tenant ID for Microsoft Graph access.".into()),
                scope: Some("tenant".into()),
            },
            DescribeSecretRequirement {
                key: "MS_GRAPH_CLIENT_ID".into(),
                required: true,
                description: Some("Client ID for Microsoft Graph access.".into()),
                scope: Some("tenant".into()),
            },
            DescribeSecretRequirement {
                key: "MS_GRAPH_CLIENT_SECRET".into(),
                required: true,
                description: Some("Client secret used to obtain Graph access tokens.".into()),
                scope: Some("tenant".into()),
            },
        ],
    }
