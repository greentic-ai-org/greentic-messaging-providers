...
pub trait Guest {
    ...
    fn format_message(destination_json: _rt::String, text: _rt::String) -> _rt::String;
}
#[doc(hidden)]
macro_rules! __export_world_teams_cabi {
...
#[doc(hidden)]
pub(crate) use __export_world_teams_cabi;
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_teams_impl {
    ($ty:ident) => {
        self::export!($ty with_types_in self);
    };
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*:: __export_world_teams_cabi!($ty with_types_in
        $($path_to_types_root)*);
    };
}
#[doc(inline)]
pub(crate) use __export_teams_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:provider:teams@0.0.1:teams:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 2312] = *b"\
...
sons\x04texts\0s\x04\0\x0eformat-message\x01\x0c\x04\0\x1aprovider:teams/teams@0\
.0.1\x04\0\x0b\x0b\x01\0\x05teams\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\
